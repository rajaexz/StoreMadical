...
class ColorResources {
  static Color getGreyColor(BuildContext context) {
    ...
    const Color(0xFFb2b8bd) : const Color(0xFFE4EAEF);
  }


  static Color getDarkColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ?
    const Color(0xFF4d5054) : const Color(0xFF25282B);
  }


  static Color getFooterTextColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ?
    const Color(0xFFFFFFFF) : const Color(0xFF515755);
  ...
  static Color getGreyLightColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ?
    const Color(0xFFb2b8bd) : const Color(0xFF98a1ab);
  }


  static Color getCategoryBgColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? const
    Color(0xFFFFFFFF) : const Color(0xFFb2b8bd);
  }
  ...
  static Color getAppBarHeaderColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ?
    const Color(0xFF111B8E) : const Color(0xFFEDF4F2);
  }
  ...
  static const Color colorGreen = Color(0xff103780);
